...
static void BM_RedisCpp_Hmset(benchmark::State& state) {
    ...
    try {
        ...
        for (auto _ : state) {
            ...
            auto response = rediscpp::execute(*stream, "HMSET", key, "field1", "value1", "field2", "value2", "field3", "value3");
